...
class force_interaction extends Phaser.Scene {
    constructor() {
        ...
        preload (){
            ...
            this.load.image('end5_button', 'assets/textures/end5_button.png')
            ...
            this.load.image('end5_1D', 'assets/textures/cutscene_end5_1D.png')
      ...
      if (this.secretBuffer.includes("i do not need any more riches, for i am already far wealthier than any puny king")) {
       ...
       if (this.secretBuffer.includes("the boss is not bossing in the boss level")) {
        ...
        cheat4 = true;
            ...
            end5_button.on('pointerdown', () => {
                this.scene.start('end5'),
                console.log("end5_play");
            });
...
// Debug: seuraa kutsuja disableBody-metodille (näytetään pinosta löytyvä trace)
        ...
        this.time.addEvent({
            ...
            this.cannons2 = [
            this.physics.add.image(10, 510, 'cannon'),
        ];
 ...
 this.cannons_back = [
        ...
        this.time.addEvent({
         ...
         this.cannons_back2 = [
           this.physics.add.image(1100, 510, 'cannon_back'),
        ];
...
const boss_dialogy_5S = new Audio('assets/sound/dialogue/boss_dialogue_5.m4a')
const boss_dialogy_6S = new Audio('assets/sound/dialogue/boss_dialogue_6.m4a')
const boss_dialogy_7S = new Audio('assets/sound/dialogue/boss_dialogue_7.m4a')
const boss_dialogy_8S = new Audio('assets/sound/dialogue/boss_dialogue_8.m4a')
const boss_dialogy_9S = new Audio('assets/sound/dialogue/boss_dialogue_9.m4a')
const boss_dialogy_10S = new Audio('assets/sound/dialogue/boss_dialogue_10.m4a')
...
const end4_4s = new Audio('assets/sound/dialogue/end4D_4.m4a')
const end5_1s = new Audio('assets/sound/dialogue/end5D_1.m4a')
const end5_2s = new Audio('assets/sound/dialogue/end5D_2.m4a')
const end5_3s = new Audio('assets/sound/dialogue/end5D_3.m4a')
const end5_4s = new Audio('assets/sound/dialogue/end5D_4.m4a')
const boss_cheat_dialogue_1 = new Audio('assets/sound/dialogue/boss_cheat_dialogue_1.m4a')
